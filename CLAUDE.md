# CLAUDE.md — Cérebro Pessoal de Fabiana Furtado

> Instruções pro Claude Code / Cowork / OpenClaw operar neste cérebro pessoal.

## Contexto

Este é o **cérebro pessoal individual** de **Fabiana Furtado**, sócio-diretor da Aria Systems. Agente default: **Aria**.
...
O Claude atua como **estação de trabalho individual** de Fabiana Furtado:
...
- `agentes/aria/` — config + memory local (daily notes)
...
3. **Daily notes automáticas em `agentes/aria/memory/YYYY-MM-DD.md`** — criadas pelo agente durante uso.
